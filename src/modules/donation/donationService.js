...
const get= (termo="",category="", priority ="todas")=>{
const search = termo.toLocaleLowerCase().trim();
return necessidades.filter(item=> (item.nome.toLocaleLowerCase().includes(search)||
 item.categoria.toLocaleLowerCase().includes(category.toLocaleLowerCase)));
